        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          {contacts.map(contact => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex flex-col items-center px-6 py-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl hover:border-indigo-500 transition-colors"
            >

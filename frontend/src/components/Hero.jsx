  ...
  return (
    <section className="min-h-screen flex items-center justify-center pt-20 px-6">
      <div className="max-w-3xl text-center">
        ...
        <h2 className="text-2xl text-indigo-600 dark:text-indigo-400 font-semibold mb-6">
          AI Engineer
        </h2>
        ...
        <div className="flex justify-center gap-4">
          ...
          <a
            href="#contact"
            className="px-6 py-3 border border-indigo-600 text-indigo-600 dark:text-indigo-400 dark:border-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-950 rounded-lg font-medium transition-colors"
          >
            Contact Me
          </a>
          <div className="relative">
            <button
              ...
              className="px-6 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg font-medium transition-colors flex items-center gap-2"
            >
              Download Resume
